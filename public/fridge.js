import { fridgeState, onFridge, fridgeDay } from "./fridge-model.js?v=3.10";
  ...
  function render() {
    ...
    const visits =
      p.trainerSchedule?.visits
        .filter(
          (v) =>
            v.end >= Date.now() - 12 * 3600000 &&
            fridgeDay(v.start) <= fridgeDay(),
        )
