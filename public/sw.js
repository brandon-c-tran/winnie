const CACHE = "winnie-v3-20260911-r14";
const SHELL = [
  "/places.js?v=3.8.1",
  "/places-view.js?v=3.8.1",
  "/geo/cities.json",
  "/geo/land.json",
  "/",
  "/index.html",
  ...
  "/sync.js?v=3.8.1",
  "/insights.js?v=3.8.1",
  "/insight-view.js?v=3.8.1",
  "/companion.js?v=3.8.1",
  "/selection.js?v=3.8.1",
  "/care-state.js?v=3.8.1",
  "/auto-place.js?v=3.8.1",
  "/fridge.js?v=3.8.1",
  "/fridge-model.js?v=3.8.1",
  "/photos/winnie-pixel-v2.png",
  "/everyday.js?v=3.8.1",
  "/vendor/suncalc.js",
  "/manifest.json?v=3.8.1",
